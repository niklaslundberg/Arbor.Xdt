...
namespace Arbor.Xdt
{
    ...
    public abstract class Transform
    {
        ...
        protected bool ApplyTransformToAllTargetNodes {
            get => applyTransformToAllTargetNodes;
            set => applyTransformToAllTargetNodes = value;
        }

        protected bool UseParentAsTargetNode {
            get => useParentAsTargetNode;
            set => useParentAsTargetNode = value;
        }

        protected MissingTargetMessage MissingTargetMessage {
            get => missingTargetMessage;
            set => missingTargetMessage = value;
        }
